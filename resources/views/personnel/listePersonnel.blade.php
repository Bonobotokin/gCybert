                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="material-design-btn">
                                <button type="button" class="btn notika-btn-indigo waves-effect " data-toggle="modal" data-target="#modification_{{$personnel['id']}}">Modification</button>
                                <button type="button" class="btn notika-btn-red waves-effect " data-toggle="modal" data-target="#delPersonnel_{{$personnel['id']}}">Supprimer</button>

                            </td>
                        </tr>

                        <div class="modal fade" id="modification_{{$personnel['id']}}" role="dialog">
                            <div class="modal-dialog modal-large">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <h2>Modification du personnel {{$personnel['nom']}}</h2>
                                        <form class="form-sample" action="{{ route('personnel.update', $personnel['id']) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                    <div class="form-group ic-cmp-int">
                                                        ...
                                                        <div class="nk-int-st">
                                                            <input type="text" name="nom" class="form-control @error('nom') is-invalid @enderror" value="{{$personnel['nom']}}" placeholder="nom" autofocus autocomplete="nom" />
                                                            @error('nom')
                                                        ...
                                                        <div class="nk-int-st">
                                                            <select class="form-control" name="sexe">
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <option selected value="0">Feminin</option>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-group ic-cmp-int">
                                                        ...
                                                        <div class="nk-int-st">
                                                            <input type="text" name="age" class="form-control  @error('age') is-invalid @enderror" value="{{ $personnel['age'] }}" placeholder="ages">
                                                            @error('age')
                                                            <span class="invalid-feedback" role="alert">
                                                                <code>{{ $message }}</code>
                                                            </span>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-group ic-cmp-int">
                                                        ...
                                                        <div class="nk-int-st">
                                                            <input type="number" name="salaire" class="form-control @error('salaire') is-invalid @enderror" value="{{ $personnel['salaire_base'] }}" placeholder="salaire" autofocus autocomplete="salaire" />
                                                            @error('salaire')
                                                            <span class="invalid-feedback" role="alert">
                                                                <code>{{ $message }}</code>
                                                            </span>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                    <div class="form-group ic-cmp-int">
                                                        ...
                                                        <div class="nk-int-st">
                                                            <input type="text" name="cin" class="form-control  @error('cin') is-invalid @enderror" value="{{ $personnel['cin'] }}" data-mask="214 011 100 682" placeholder="cin" autofocus autocomplete="cin" />
                                                            @error('cin')
                                                            <span class="invalid-feedback" role="alert">
                                                                <code>{{ $message }}</code>
                                                            </span>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                    <div class="form-group ic-cmp-int">
                                                        ...
                                                        <div class="nk-int-st">
                                                            <input type="text" name="telephone" class="form-control  @error('telephone') is-invalid @enderror" value="{{ $personnel['telephone'] }}" data-mask="261 34 66 971 88" placeholder="telephone" autofocus autocomplete="telephone" />
                                                            @error('telephone')
                                                            <span class="invalid-feedback" role="alert">
                                                                <code>{{ $message }}</code>
                                                            </span>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                    ...
                                                    <div class="form-group ic-cmp-int form-elet-mg res-mg-fcs">
                                                        ...
                                                        <div class="nk-int-st">
                                                            <input type="text" name="adresse" class="form-control @error('adresse') is-invalid @enderror" value="{{ $personnel['adresse'] }}" placeholder="adresse" autofocus autocomplete="adresse" />
                                                            @error('adresse')
                                                            <span class="invalid-feedback" role="alert">
                                                                <code>{{ $message }}</code>
                                                            </span>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-group ic-cmp-int">
                                                        ...
                                                        <div class="nk-int-st">
                                                            <input type="text" name="name" id="pseudo" onkeyup="getEmail()" class="form-control @error('name') is-invalid @enderror" value="{{ $personnel['nom_user'] }}" placeholder="pseudo" autofocus autocomplete="name" />
                                                            @error('name')
                                                            <span class="invalid-feedback" role="alert">
                                                                <code>{{ $message }}</code>
                                                            </span>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-group ic-cmp-int">
                                                        ...
                                                        <div class="nk-int-st">
                                                            <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ $personnel['email'] }}" placeholder="email" autofocus autocomplete="email" />
                                                            @error('email')
                                                            <span class="invalid-feedback" role="alert">
                                                                <code>{{ $message }}</code>
                                                            </span>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-group ic-cmp-int">
                                                        ...
                                                        <div class="nk-int-st">
                                                            <input type="password" name="mdp" class="form-control @error('password') is-invalid @enderror" value="{{ $personnel['password'] }}" placeholder="mot de passe" autofocus autocomplete="password" />
                                                            @error('password')
                                                            <span class="invalid-feedback" role="alert">
                                                                <code>{{ $message }}</code>
                                                            </span>
                                                        ...
                                                        <div class="nk-int-st">
                                                            <select name="role" class="form-control" id="">
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <option selected value="1">Moderateur</option>
                                                                <?php
                                                                }
                                                                ?>
                                                            </select>
                        ...
                        <div class="modal fade" id="delPersonnel_{{$personnel['id']}}" role="dialog">
                            <div class="modal-dialog modal-large">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    ...
                                    <div class="modal-body">
                                        <form class="form-sample" action="{{ route('personnel.delete', $personnel['id']) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <p>Vous voullez supprimer {{$personnel['nom']}} </p>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
