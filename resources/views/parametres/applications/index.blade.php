                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="form-group ic-cmp-int">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" id="myInput" name="designation" class="form-control" placeholder="designation" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="form-group ic-cmp-int">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" id="materielsInput2" name="designation" class="form-control" placeholder="designation" />
                                    @error('designation')
                                    <span class="invalid-feedback" role="alert">
                                        <code>{{ $message }}</code>
                                    </span>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="form-group ic-cmp-int">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" id="conditMater" name="conditionnement" class="form-control  @error('conditionnement') is-invalid @enderror" :value="{{ old('conditionnement') }}" placeholder="conditionnement">
...
<script>
    ...
    function autocompleteMateriels(inp, arr) {
        /*the autocomplete function takes two arguments,
        the text field element and an array of possible autocompleted values:*/
        var currentFocus;
        /*execute a function when someone writes in the text field:*/
    ...
    function autocompleteMaterielsCondit(inp, arr) {
        /*the autocomplete function takes two arguments,
        the text field element and an array of possible autocompleted values:*/
        var currentFocus;
        /*execute a function when someone writes in the text field:*/
    ...
    autocomplete(document.getElementById("myInput"), service);
    autocompleteMateriels(document.getElementById("materielsInput2"), materiels);
    autocompleteMaterielsCondit(document.getElementById("conditMater"), materielsCondit);
</script>
@endsection