...
<head>
	...
	<!-- favicon
		============================================ -->
	<link rel="shortcut icon" type="{{asset ('assets/image/x-icon')}}" href="img/favicon.ico">
	<!-- Google Fonts
		============================================ -->
...
<body>
	...
	<div class="login-content">
		<!-- Login -->
		<form class="nk-block toggled" id="l-login" method="POST" action="{{ route('login') }}">
			@csrf
			<div class="nk-form">
				...
				<div class="nk-navigation nk-lg-ic">
					<button class="btn btn-danger notika-btn-success waves-effect">Annuler</button>
					<button class="btn btn-success notika-btn-success waves-effect">Connexion</button>
				</div>
